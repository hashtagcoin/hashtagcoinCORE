...
#define BOOST_TEST_MODULE Hashtagcoin Test Suite

#include "test_hashtagcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_hashtagcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

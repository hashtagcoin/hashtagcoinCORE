...
#ifndef HASHTAGCOIN_TEST_SCRIPTNUM10_H
#define HASHTAGCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hashtagcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // HASHTAGCOIN_TEST_BIGNUM_H

...
# Copyright 2016 The Hashtagcoin Core developers
...
help_text="""Test framework for hashtagcoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/hashtagcoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "hashtagcoin-util-test.json", buildenv)

...
#ifndef HASHTAGCOIN_WALLET_WALLET_H
#define HASHTAGCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this hashtagcoin node, and set to 0 for transactions that were created
...
#endif // HASHTAGCOIN_WALLET_WALLET_H

 ...
 * between hashtagcoind, and hashtagcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("hashtagcoin-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), HASHTAGCOIN_CONF_FILENAME));
    if (mode == HMM_HASHTAGCOIND)
    {
#if HAVE_DECL_DAEMON
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), HASHTAGCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hashtagcoin/hashtagcoin>";
    const std::string URL_WEBSITE = "<https://hashtagcoincore.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("hashtagcoin-loadblk");
...
/** Sanity checks
 *  Ensure that Hashtagcoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Hashtagcoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Hashtagcoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(GetArg("-conf", HASHTAGCOIN_CONF_FILENAME)).string());

...
class RawTransactionsTest(HashtagcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid hashtagcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid hashtagcoin address" in e.error['message'])

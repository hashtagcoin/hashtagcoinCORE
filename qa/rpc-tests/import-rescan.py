...
import RPC call and node 0 sends HASH to it. Then other nodes import the
...
In the second part of the test, node 0 sends more HASH to each address, and the
...
class ImportRescanTest(HashtagcoinTestFramework):
    def __init__(self):
        super().__init__()

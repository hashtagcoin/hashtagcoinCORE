...
# TestNode: A peer we use to send messages to hashtagcoind, and store responses.
...
class CompactBlocksTest(HashtagcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes hashtagcoind to (reasonably!) disconnect us, so do this last.
    ...
    # hashtagcoind's choice of nonce.
    ...
    # Test that hashtagcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for hashtagcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # hashtagcoind will not send blocktxn responses for blocks whose height is

...
unlocked to sign the Hashtagcoin-Qt.app bundle.
...
allowing somebody to distribute a Hashtagcoin-Qt.app or hashtagcoin-qt-setup.exe with a valid
...
that the hashtagcoin-qt.exe file inside the installer had not been tampered with.

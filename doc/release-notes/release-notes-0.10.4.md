Hashtagcoin Core version 0.10.4 is now available from:

  <https://hashtagcoin.org/bin/hashtagcoin-core-0.10.4/>
...
- #6953 `43c2789` Split hashtagcoin-tx into its own package
- #6953 `dfe0d4d` Include hashtagcoin-tx binary on Debian/Ubuntu

Download URL: https://sourceforge.net/projects/hashtagcoin/files/Hashtagcoin/hashtagcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 HASH fee schedule (users still pay 0.01 HASH per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #hashtagcoin00 - #hashtagcoin99

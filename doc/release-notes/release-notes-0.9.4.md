Hashtagcoin Core version 0.9.4 is now available from:

  https://hashtagcoin.org/bin/0.9.4/
...
this update is incompatible with the Hashtagcoin system and could lead to consensus
forks.

Hashtagcoin Core released binaries from https://hashtagcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hashtagcoin/+archive/ubuntu/hashtagcoin
- A third-party or self-compiled Hashtagcoin Core

upgrade to Hashtagcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

Hashtagcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hashtagcoin/files/Hashtagcoin/hashtagcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Hashtagcoin
...
New/changed settings (command-line or hashtagcoin.conf file)
--------------------------------------------------------

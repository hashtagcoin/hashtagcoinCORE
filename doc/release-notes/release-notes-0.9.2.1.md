Hashtagcoin Core version 0.9.2.1 is now available from:

  https://hashtagcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HASH to 0.01 HASH
...
- Fix "Start hashtagcoin on system login"

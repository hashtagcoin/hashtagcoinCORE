Hashtagcoin Core version 0.13.2 is now available from:

  <https://hashtagcoin.org/bin/hashtagcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update hashtagcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow hashtagcoin-tx to create v2 transactions (HASHdrak)

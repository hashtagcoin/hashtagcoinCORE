Hashtagcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hashtagcoin/files/Hashtagcoin/hashtagcoin-0.5.4/
...
http://gitorious.org/hashtagcoin/hashtagcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Hashtagcoin-Qt notifications under Growl 1.3.
Increase required age of Hashtagcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHashtagcoin properly when installing Hashtagcoin-Qt over it. (Windows)
